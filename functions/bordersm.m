...
if strncmpi(place,'europe_no_Norway',4)
    plotWhat = 'europe_no_Norway';
end    

if strncmpi(place,'europe_Norway',4)
    plotWhat = 'europe_Norway';
end    
...
switch plotWhat
    ...
    case 'europe_no_Norway'
        lat = bd.lat([45 51 53 60 65 72 82 154 101 102 103 164 175 191 207]);  % remove 155 for Norway
        lon = bd.lon([45 51 53 60 65 72 82 154 101 102 103 164 175 191 207]);  
    case 'europe_Norway'
        lat = bd.lat([45 51 53 60 65 72 82 154 101 102 103 155 164 175 191 207]);  
        lon = bd.lon([45 51 53 60 65 72 82 154 101 102 103 155  164 175 191 207]);   
end
